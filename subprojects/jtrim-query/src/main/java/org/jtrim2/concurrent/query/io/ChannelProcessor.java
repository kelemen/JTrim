...
public interface ChannelProcessor<DataType, ChannelType extends Channel> {
    ...
    public static interface StateListener {
         ...
         * through the {@link org.jtrim2.concurrent.query.AsyncDataController#getDataState() getDataState}
         * method of the {@link org.jtrim2.concurrent.query.AsyncDataController AsyncDataController}
