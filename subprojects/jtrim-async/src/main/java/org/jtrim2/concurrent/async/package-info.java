 ...
 *
 * <h3>Data links</h3>
 * {@link org.jtrim2.concurrent.async.AsyncDataLink Data links} are the
 ...
 * required.
 * <P>
 * The base interface for data links is {@link org.jtrim2.concurrent.async.AsyncDataLink}
 ...
 * thread and notify the specified {@link org.jtrim2.concurrent.async.AsyncDataListener listener}
 * when the data is available. A usually sufficient implementation is
 * to submit a task to a {@link org.jtrim2.concurrent.TaskExecutorService TaskExecutorService}
 ...
 * {@link org.jtrim2.concurrent.async.AsyncLinks} contains convenient factory
 * methods.
 *
 * <h3>Data queries</h3>
 ...
 * {@link org.jtrim2.concurrent.async.AsyncDataQuery data queries} were created.
 * <P>
 * The base interface for data queries is {@link org.jtrim2.concurrent.async.AsyncDataQuery}
 ...
 * {@link org.jtrim2.concurrent.async.AsyncQueries} contains convenient factory
 ...
 * likely to occur.
 *
 * @see org.jtrim2.concurrent.async.AsyncDataLink
 * @see org.jtrim2.concurrent.async.AsyncDataQuery
 *
 * @see org.jtrim2.concurrent.async.AsyncHelper
 * @see org.jtrim2.concurrent.async.AsyncLinks
 * @see org.jtrim2.concurrent.async.AsyncQueries
 */
