...
public class SimpleAsyncImageDisplay<ImageAddressType> extends AsyncImageDisplay<ImageAddressType> {
            ...
            public void enterZoomToFitMode(Set<ZoomToFitOption> options) {
                ...
                if (imageMetaData != null) {
                    ...
                    if (imageWidth > 0 && imageHeight > 0) {
                        ...
                        newTransformations = org.jtrim2.image.transform.ZoomToFitTransformer.getBasicTransformations(
                                imageWidth,
                                imageHeight,
                                currentWidth,
                                currentHeight,
    ...
    public ImagePointTransformer getPointTransformer() {
        ...
        if (metaData != null) {
            ...
            AffineTransform transfMatrix = org.jtrim2.image.transform.AffineImageTransformer.getTransformationMatrix(
    ...
    private void setCurrentTransformations(int index, Color bckgColor) {
        ...
        if (zoomToFit == null) {
            if (!org.jtrim2.image.transform.AffineImageTransformer.isSimpleTransformation(currentTransf)) {
                ...
                for (InterpolationType interpolationType: interpolationTypes) {
                    ...
                    org.jtrim2.image.transform.ImageTransformer imageTransformer;
                    imageTransformer = new org.jtrim2.image.transform.AffineImageTransformer(
                ...
                org.jtrim2.image.transform.ImageTransformerQuery query;
                query = new org.jtrim2.image.transform.ImageTransformerQuery(imageTransformers);
                ...
                org.jtrim2.image.transform.ImageTransformerQuery query;
                query = new org.jtrim2.image.transform.ImageTransformerQuery(executor, imageTransformer);
            ...
            for (InterpolationType interpolationType: interpolationTypes) {
                TaskExecutorService executor = getExecutor(interpolationType);
                org.jtrim2.image.transform.ImageTransformer imageTransformer;
                imageTransformer = new org.jtrim2.image.transform.ZoomToFitTransformer(
                        currentTransf, zoomToFit, bckgColor, interpolationType);

                AsyncDataConverter<
                        org.jtrim2.image.transform.ImageTransformerData,
                        org.jtrim2.image.transform.TransformedImageData> asyncTransformer;
    ...
    @Deprecated
    private final class ZoomToFitDataGatherer implements org.jtrim2.image.transform.ImageTransformer {
        private final BasicImageTransformations transBase;
        private final org.jtrim2.image.transform.ImageTransformer wrappedTransformer;
        ...
        public ZoomToFitDataGatherer(BasicImageTransformations transBase,
                org.jtrim2.image.transform.ImageTransformer wrappedTransformer,
        ...
        @Override
        public TransformedImage convertData(org.jtrim2.image.transform.ImageTransformerData input) {
