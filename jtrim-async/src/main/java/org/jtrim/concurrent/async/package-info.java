 ...
 *
 * <h3>Data links</h3>
 * {@link org.jtrim.concurrent.async.AsyncDataLink Data links} are the
 ...
 * required.
 * <P>
 * The base interface for data links is {@link org.jtrim.concurrent.async.AsyncDataLink}
 ...
 * {@link org.jtrim.concurrent.async.AsyncLinks} contains convenient factory
 * methods.
 *
 * <h3>Data queries</h3>
 ...
 * {@link org.jtrim.concurrent.async.AsyncDataQuery data queries} were created.
 * <P>
 * The base interface for data queries is {@link org.jtrim.concurrent.async.AsyncDataQuery}
 ...
 * {@link org.jtrim.concurrent.async.AsyncQueries} contains convenient factory
 ...
 * likely to occur.
 *
 * @see org.jtrim.concurrent.async.AsyncDataLink
 * @see org.jtrim.concurrent.async.AsyncDataQuery
 *
 * @see org.jtrim.concurrent.async.AsyncHelper
 * @see org.jtrim.concurrent.async.AsyncLinks
 * @see org.jtrim.concurrent.async.AsyncQueries
 */
