...
public interface ChannelProcessor<DataType, ChannelType extends Channel> {
    ...
    public static interface StateListener {
         ...
         * through the {@link org.jtrim.concurrent.async.AsyncDataController#getDataState() getDataState}
         * method of the {@link org.jtrim.concurrent.async.AsyncDataController AsyncDataController}
