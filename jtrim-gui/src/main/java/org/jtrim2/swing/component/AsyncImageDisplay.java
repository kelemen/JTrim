...
import org.jtrim2.concurrent.async.AsyncQueries;
import org.jtrim2.concurrent.async.AsyncReport;
import org.jtrim2.concurrent.async.CachedLinkRequest;
import org.jtrim2.concurrent.async.DataConverter;
import org.jtrim2.concurrent.async.DataWithUid;
import org.jtrim2.concurrent.async.MultiAsyncDataState;
 ...
 * an {@link org.jtrim2.swing.concurrent.async.AsyncRenderer}. Therefore it must
...
public class AsyncImageDisplay<ImageAddress> extends AsyncRenderingComponent {
    ...
    private AsyncDataQuery<? super ImageAddress, ? extends org.jtrim2.image.ImageData> rawImageQuery;
    private AsyncDataQuery<ImageAddress, DataWithUid<org.jtrim2.image.ImageData>> imageQuery;
    private ImageAddress currentImageAddress;

    private AsyncDataLink<DataWithUid<org.jtrim2.image.ImageData>> imageLink;
     ...
     * {@link org.jtrim2.swing.concurrent.async.AsyncRenderer} to be used. Therefore the
     ...
     * {@link org.jtrim2.swing.concurrent.async.AsyncRenderer}
     ...
     *   {@code null} was set.
     */
    public final AsyncDataQuery<? super ImageAddress, ? extends org.jtrim2.image.ImageData> getImageQuery() {
    ...
    public final void setImageQuery(
            AsyncDataQuery<? super ImageAddress, ? extends org.jtrim2.image.ImageData> imageQuery) {
    ...
    public final void setImageQuery(
        ...
        AsyncDataLink<DataWithUid<org.jtrim2.image.ImageData>> newLink = null;
    ...
    private static final class WeakRefAndID {
        public final WeakReference<org.jtrim2.image.ImageData> imageRef;
        public final Object id;

        public WeakRefAndID(org.jtrim2.image.ImageData image) {
            this.imageRef = new WeakReference<>(image);
            this.id = new Object();
        }
    }

    private AsyncDataQuery<ImageAddress, DataWithUid<org.jtrim2.image.ImageData>> wrapQuery(
            final AsyncDataQuery<? super ImageAddress, ? extends org.jtrim2.image.ImageData> query) {
        assert query != null;

        return (ImageAddress arg) -> {
            final AsyncDataLink<? extends org.jtrim2.image.ImageData> link = query.createDataLink(arg);

            return new AsyncDataLink<DataWithUid<org.jtrim2.image.ImageData>>() {
                ...
                public AsyncDataController getData(
                        ...
                        final AsyncDataListener<? super DataWithUid<org.jtrim2.image.ImageData>> dataListener) {
                    ExceptionHelper.checkNotNullArgument(dataListener, "dataListener");

                    return link.getData(cancelToken, new AsyncDataListener<org.jtrim2.image.ImageData>() {
                        private WeakRefAndID refAndID = null;

                        @Override
                        public void onDataArrive(org.jtrim2.image.ImageData data) {
     ...
     * {@link #setImageQuery(org.jtrim2.concurrent.async.AsyncDataQuery) image query})
    ...
    private void setBasicRenderingArgs(
            final AsyncDataLink<DataWithUid<org.jtrim2.image.ImageData>> imageLinkOfRendering,
    ...
    private void setImageLink(AsyncDataLink<DataWithUid<org.jtrim2.image.ImageData>> imageLink) {
     ...
     * {@link org.jtrim2.image.transform.ImageTransformerData} for inputs and produces an
     ...
     *   {@link org.jtrim2.cache.JavaRefObjectCache#INSTANCE}. If you do not need
    ...
    public void setImageTransformer(int index,
            ...
            AsyncDataQuery<
                    org.jtrim2.image.transform.ImageTransformerData,
                    org.jtrim2.image.transform.TransformedImageData> imageTransformer) {
     ...
     *   case {@link org.jtrim2.cache.JavaRefObjectCache#INSTANCE} is used.
     * @param imageTransformer the image transformer to be applied. This
     *   argument cannot be {@code null}.
     *
     * @throws NullPointerException thrown if the {@code refType} or the image
     ...
     * {@link org.jtrim2.swing.concurrent.async.AsyncRenderer} of this
    ...
    implements
        ...
        private final AsyncDataQuery<
                CachedLinkRequest<DataWithUid<org.jtrim2.image.transform.ImageTransformerData>>,
                DataWithUid<org.jtrim2.image.transform.TransformedImageData>> cachedTransformerQuery;

        public CachedQuery(
                AsyncDataQuery<
                        org.jtrim2.image.transform.ImageTransformerData,
                        org.jtrim2.image.transform.TransformedImageData> imageTranformerQuery,
                ReferenceType refType, ObjectCache refCreator) {
        ...
        public AsyncDataLink<DataWithUid<InternalTransformerData>> createDataLink(
            ...
            org.jtrim2.image.ImageReceiveException prevException = arg.getException();
            ...
            CachedLinkRequest<DataWithUid<org.jtrim2.image.transform.ImageTransformerData>> request;
            request = new CachedLinkRequest<>(
                    new DataWithUid<>(arg.getTransformerData(), argWithID.getID()),
                    Long.MAX_VALUE, TimeUnit.NANOSECONDS);

            AsyncDataLink<DataWithUid<org.jtrim2.image.transform.TransformedImageData>> transformerLink;
    ...
    implements
            DataConverter<DataWithUid<org.jtrim2.image.transform.TransformedImageData>,
            DataWithUid<InternalTransformerData>> {

        private final ImagePointTransformer prevPointTransformer;
        private final org.jtrim2.image.ImageReceiveException prevException;
        ...
        public ToInternalConverterLink(
                ...
                org.jtrim2.image.ImageReceiveException prevException,
        ...
        public DataWithUid<InternalTransformerData> convertData(
                DataWithUid<org.jtrim2.image.transform.TransformedImageData> data) {

            org.jtrim2.image.transform.TransformedImageData resultImageData = data.getData();
            ...
            org.jtrim2.image.ImageReceiveException transfException;
            ...
            if (prevException == null) {
                ...
                exception = new org.jtrim2.image.ImageReceiveException();
    ...
    implements
            DataConverter<DataWithUid<org.jtrim2.image.ImageData>,
            DataWithUid<InternalTransformerData>> {
        ...
        @Override
        public DataWithUid<InternalTransformerData> convertData(
                DataWithUid<org.jtrim2.image.ImageData> data) {

            org.jtrim2.image.ImageData imageData = data.getData();
    ...
    private static class InternalPaintResult {
        ...
        private final ImageMetaData metaData;
        private final AsyncDataLink<DataWithUid<org.jtrim2.image.ImageData>> imageLink;

        public InternalPaintResult(boolean imageReceived,
                ImagePointTransformer pointTransformer,
                ImageMetaData metaData,
                AsyncDataLink<DataWithUid<org.jtrim2.image.ImageData>> imageLink) {
        ...
        public AsyncDataLink<DataWithUid<org.jtrim2.image.ImageData>> getImageLink() {
            return imageLink;
        }
    ...
    private static class InternalTransformerData  {
        ...
        private final ImageMetaData metaData;
        private final boolean receivedImage;
        private final org.jtrim2.image.transform.TransformedImageData transformedImageData;
        ...
        public InternalTransformerData(
            ...
            this.transformedImageData
                    = new org.jtrim2.image.transform.TransformedImageData(transformedImage, exception);
        }

        public org.jtrim2.image.transform.ImageTransformerData getTransformerData() {
            return new org.jtrim2.image.transform.ImageTransformerData(
                    getImage(),
                    getDestWidth(),
                    getDestHeight(),
                    getMetaData());
    ...
    private class ImageChangeHandler implements EventDispatcher<ImageListener, Void> {
        ...
        public void onEvent(ImageListener eventArgument, Void arg) {
            AsyncDataLink<DataWithUid<org.jtrim2.image.ImageData>> currentLink = imageLink;
