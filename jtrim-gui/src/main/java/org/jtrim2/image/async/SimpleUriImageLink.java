...
import org.jtrim2.concurrent.async.AsyncHelper;
 ...
 */
@Deprecated
public final class SimpleUriImageLink implements AsyncDataLink<org.jtrim2.image.ImageData> {
    ...
    private static org.jtrim2.image.ImageData createData(
            BufferedImage image,
            ImageMetaData metaData,
            org.jtrim2.image.ImageReceiveException exception) {
        return new org.jtrim2.image.ImageData(image, metaData, exception);
    }
    ...
    public AsyncDataController getData(
            ...
            AsyncDataListener<? super org.jtrim2.image.ImageData> dataListener) {
        ExceptionHelper.checkNotNullArgument(cancelToken, "cancelToken");
        ExceptionHelper.checkNotNullArgument(dataListener, "dataListener");

        final AsyncDataListener<org.jtrim2.image.ImageData> safeListener
    ...
    private static class PartialImageUpdater extends IIOReadUpdateAdapter {
        private final AsyncDataListener<org.jtrim2.image.ImageData> safeListener;
        ...
        public PartialImageUpdater(
                AsyncDataListener<org.jtrim2.image.ImageData> safeListener,
                ImageMetaData metaData,
                long minUpdateTime) {
    ...
    private static class ImageReaderTask implements CancelableTask {
        ...
        private ImageWithMetaData readImage(
                ...
                AsyncDataListener<org.jtrim2.image.ImageData> safeListener) throws IOException {
        ...
        private void retrieveImage() {
            ...
            try {
                ...
                safeListener.onDataArrive(createData(
                        lastImage,
                        lastMetaData,
                        new org.jtrim2.image.ImageReceiveException(ex)));
