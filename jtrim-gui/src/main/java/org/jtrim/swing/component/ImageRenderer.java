 ...
 * This interface differs from {@link org.jtrim.swing.concurrent.async.DataRenderer}
...
public interface ImageRenderer<DataType, ResultType> {
     ...
     *   {@code BufferedImage}) or throw an {@link org.jtrim.cancel.OperationCanceledException}
