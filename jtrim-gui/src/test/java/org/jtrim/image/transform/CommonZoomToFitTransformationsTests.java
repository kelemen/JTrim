...
public final class CommonZoomToFitTransformationsTests {
    ...
    private final CommonZoomToFitTransformations tested;

    public CommonZoomToFitTransformationsTests(CommonZoomToFitTransformations tested) {
    ...
    private void executeAllTests(Class<? extends Annotation> annotation) throws ReflectiveOperationException {
        ...
        int failureCount = 0;
        for (Method method: CommonZoomToFitTransformationsTests.class.getMethods()) {
    ...
    private void assertConversion(
        ...
        for (InterpolationType interpolation : InterpolationType.values()) {
            ...
            TransformedImage converted =
                    tested.doTransform(srcImage, destWidth, destHeight, options, transBase, interpolation);
    ...
    public void testTransformationsZeroOrNegativeSourceWidth() {
        for (int srcWidth: Arrays.asList(Integer.MIN_VALUE, -1, 0)) {
            ...
            BasicImageTransformations transformations = tested.getBasicTransformations(
