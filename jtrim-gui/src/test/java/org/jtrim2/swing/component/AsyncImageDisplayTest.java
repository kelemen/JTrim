...
import org.jtrim2.concurrent.async.CachedAsyncDataQuery;
import org.jtrim2.concurrent.async.CachedDataRequest;
...
public class AsyncImageDisplayTest {
    ...
    public void testError() {
        try (final TestCase test = TestCase.create()) {
            test.runTest((AsyncImageDisplay<TestInput> component) -> {
                org.jtrim2.image.ImageReceiveException exception = new org.jtrim2.image.ImageReceiveException();
    ...
    public void testDoubleError() {
        try (final TestCase test = TestCase.create()) {
            test.runTest((AsyncImageDisplay<TestInput> component) -> {
                org.jtrim2.image.ImageReceiveException exception1 = new org.jtrim2.image.ImageReceiveException();
                org.jtrim2.image.ImageReceiveException exception2 = new org.jtrim2.image.ImageReceiveException();
    ...
    private static org.jtrim2.image.transform.ImageTransformerData captureTransformerArg(TestTransformation transf) {
        ArgumentCaptor<org.jtrim2.image.transform.ImageTransformerData> arg
                = ArgumentCaptor.forClass(org.jtrim2.image.transform.ImageTransformerData.class);
    ...
    public void testExceptionTransformation() {
        try (final TestCase test = TestCase.create()) {
            org.jtrim2.image.ImageReceiveException error0
                    = new org.jtrim2.image.ImageReceiveException();
            org.jtrim2.image.ImageReceiveException error1
                    = new org.jtrim2.image.ImageReceiveException();
    ...
    public void testCachedTransformation() {
        ...
        try (final TestCase test = TestCase.create()) {
            ...
            test.runTest((AsyncImageDisplay<TestInput> component) -> {
                ...
                final CachedAsyncDataQuery<CachedDataRequest<TestInput>, org.jtrim2.image.ImageData> cachedQuery
                        = AsyncQueries.cacheLinks(AsyncQueries.cacheResults(createTestQuery()));

                AsyncDataQuery<TestInput, org.jtrim2.image.ImageData> min60CachedQuery = (TestInput arg) -> {
        ...
        for (Object cacheArg: cacheArgs.getAllValues()) {
            if (!(cacheArg instanceof org.jtrim2.image.transform.TransformedImageData)) {
    ...
    private void checkOnChangeImage(int callCount, Color expectedColor, ImageListener imageListener) {
        ...
        ArgumentCaptor<AsyncDataLink<org.jtrim2.image.ImageData>> argCaptor = linkArgCaptor();
        verify(imageListener, times(callCount)).onChangeImage(argCaptor.capture());

        final AtomicReference<org.jtrim2.image.ImageData> resultRef = new AtomicReference<>();
        argCaptor.getValue().getData(
                Cancellation.UNCANCELABLE_TOKEN,
                new AsyncDataListener<org.jtrim2.image.ImageData>() {
            @Override
    ...
    implements
        ...
        private final org.jtrim2.image.ImageReceiveException error;

        public ExceptionTransformation(Color color, org.jtrim2.image.ImageReceiveException error) {
            this.color = color;
            this.error = error;
        }

        @Override
        public AsyncDataLink<org.jtrim2.image.transform.TransformedImageData> createDataLink(
                org.jtrim2.image.transform.ImageTransformerData arg) {
            ...
            org.jtrim2.image.transform.TransformedImageData transformedData
                    = new org.jtrim2.image.transform.TransformedImageData(transformed, error);
    ...
    implements
        ...
        public AsyncDataLink<org.jtrim2.image.transform.TransformedImageData> createDataLink(
            ...
            TransformedImage transformed = new TransformedImage(
                    ...
                    pointTransformer);
            org.jtrim2.image.transform.TransformedImageData transformedData
                    = new org.jtrim2.image.transform.TransformedImageData(transformed, null);
    ...
    extends
            AsyncDataQuery<
                ...
                org.jtrim2.image.transform.TransformedImageData
            > {
    ...
    implements
        ...
        public AsyncDataLink<org.jtrim2.image.transform.TransformedImageData> createDataLink(
            ...
            AsyncDataLink<org.jtrim2.image.ImageData> link = input.createLink();

            DataConverter<org.jtrim2.image.ImageData, org.jtrim2.image.transform.TransformedImageData> conv;
            conv = (org.jtrim2.image.ImageData data) -> {
                TransformedImage transformed = new TransformedImage(
                        data.getImage(),
                        pointTransformer);
                return new org.jtrim2.image.transform.TransformedImageData(transformed, null);
            };
            return AsyncLinks.convertResultSync(link, conv);
        }
    }

    public enum TestQuery implements AsyncDataQuery<TestInput, org.jtrim2.image.ImageData> {
        INSTANCE;

        @Override
        public AsyncDataLink<org.jtrim2.image.ImageData> createDataLink(TestInput arg) {
    ...
    public static interface TestInput {
        public AsyncDataLink<org.jtrim2.image.ImageData> createLink();
    ...
    public abstract static class AbstractTestInput implements TestInput {
        ...
        protected final AsyncDataLink<org.jtrim2.image.ImageData> createPreparedLink(
                final org.jtrim2.image.ImageData data,
    ...
    public static final class ErrorImage extends AbstractTestInput {
        private final org.jtrim2.image.ImageReceiveException[] exceptions;

        public ErrorImage(org.jtrim2.image.ImageReceiveException... exceptions) {
        ...
        public AsyncDataLink<org.jtrim2.image.ImageData> createLink() {
            return (cancelToken, dataListener) -> {
                try {
                    for (org.jtrim2.image.ImageReceiveException ex: exceptions) {
                        dataListener.onDataArrive(new org.jtrim2.image.ImageData(null, null, ex));
                    }
                } finally {
                    dataListener.onDoneReceive(AsyncReport.SUCCESS);
                }
    ...
    public static final class NullImage extends AbstractTestInput {
        @Override
        public AsyncDataLink<org.jtrim2.image.ImageData> createLink() {
            return createPreparedLink(new org.jtrim2.image.ImageData(null, null, null), null);
        }
    }
    ...
    public static final class ClearImage extends AbstractTestInput {
        ...
        public AsyncDataLink<org.jtrim2.image.ImageData> createLink() {
            ...
            return createPreparedLink(new org.jtrim2.image.ImageData(testImg, metaData, null), null);
        }
    }
    ...
    public static final class AsyncTestImage extends AbstractTestInput {
        ...
        public AsyncDataLink<org.jtrim2.image.ImageData> createLink() {
            ...
            final org.jtrim2.image.ImageData data = new org.jtrim2.image.ImageData(testImg, metaData, null);
            ...
            return (cancelToken, dataListener) -> {
                ...
                executor.execute(Cancellation.UNCANCELABLE_TOKEN, (CancellationToken cancelToken1) -> {
                    dataListener.onDataArrive(new org.jtrim2.image.ImageData(null, metaData, null));
